...
public class Cliente {
    ...
    public static void EnviarArchivo(File f, String pathOrigen, String pathDestino) {
        try {
            if (f.isFile()) {
                ...
                JOptionPane.showMessageDialog(null, "Se ha subido el archivo " + nombre + " con tamaño: " + tam, "Carga",JOptionPane.INFORMATION_MESSAGE);
                dis.close();
                dos.close();
                cl.close();
            } // If
    ...
    public static void RecibirArchivos(String[] nombresArchivos, int tama) {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Archivo " + nombre +  "Descargado", "Desccargar " , JOptionPane.WARNING_MESSAGE) ;
            dos.close();
            dis.close();
            dosArchivo.close();
            cl.close();
    ...
    public static void EliminarArchivo(String[] nombresArchivos, int tama) {
        try {
            ...
            long tam = dis.readLong();
            JOptionPane.showMessageDialog(null, "Archivo " + nombre + "  Eliminado " ,  "BORRAR" , JOptionPane.ERROR_MESSAGE);
            JOptionPane.showMessageDialog(null, "Actualiza la ventana", "Actualiza", JOptionPane.WARNING_MESSAGE);
            dos.close();
            dis.close();
            cl.close();
