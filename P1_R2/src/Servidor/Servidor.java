...
public class Servidor {
    ...
    public static void RecibirArchivos(DataInputStream dis, String nombre) throws IOException {
        ...
        System.out.println("\nArchivo " + nombre + " de tamaño: " + tam + " recibido.");
        dos.close();
        dis.close();
    } // RecibirArchivos
    ...
    public static void crearZIP(DataInputStream dis, int tam) {
        try {
            ...
            String destino = "C:\\Users\\jona-\\Documents\\Jona\\DescargasPractica1\\" + nombreArchivos[0] + ".zip";
    ...
    public static void EnviarArchivo(DataOutputStream dos, File f) {
        try {
            ...
            System.out.println("\nArchivo " + nombre + "Enviado Tamaño: " + tam + " bytes");
            ...
            while (enviados < tam) {
                ...
                System.out.println("\r Enviado: " + porciento + "% --- " + enviados + "/" + tam + " bytes");
            } //while
        ...
        try {
            ...
            for (i = 0; i < tam; i++) {
                ...
                if (bandera) {
                    ...
                    if (f.delete()) {
                        System.out.println("\nArchivo " + nombre + " " +  "Eliminado.");
                    } else {
                        System.out.println("\nArchivo " + nombre + " no eliminado.");
        ...
        try {
            ...
            for (;;) {
                ...
                if (bandera == 0) {
                    ...
                    int tam = dis.readInt();
                    String path = "Descarga" + numVeces + ".zip";
