...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu(PedirPlatillo pedirPlatillo, String receta) {
        initComponents();
        this.setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        jButton1.setText("Registrar Platillo");
        ...
        jButton3.setText("Buscar Platillos");
        ...
        Recibe.setFont(new java.awt.Font("Tahoma", 3, 12)); // NOI18N
        Recibe.setForeground(new java.awt.Color(153, 153, 153));
        Recibe.setRows(5);
        Recibe.setText("\n\nNO HAY NINGUN PLATILLO REGISTRADO...");
        jScrollPane3.setViewportView(Recibe);

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("PLATILLOS PREDETERMINADOS");

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("PLATILLO REGISTRADO");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        jTextArea1.setText(platilloHecho.receta(comida_1)+"\n"+platilloHecho.receta(comida_2)+"\n"
                +platilloHecho.receta(bebida_1)+"\n"+platilloHecho.receta(bebida_2)+"\n"
                +platilloHecho.receta(postre_1)+"\n"+platilloHecho.receta(postre_2)+"\n"
                +receta);     
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        platillosCadenas.add(platilloHecho.receta(comida_1));
        platillosCadenas.add(platilloHecho.receta(comida_2));
        platillosCadenas.add(platilloHecho.receta(bebida_1));
        platillosCadenas.add(platilloHecho.receta(bebida_2));
        platillosCadenas.add(platilloHecho.receta(postre_1));
        platillosCadenas.add(platilloHecho.receta(postre_2));
        platillosCadenas.add(receta);
        if(platillosCadenas == null){
            new Platillo().setVisible(true);
        }else{
            new Platillo(platillosCadenas).setVisible(true);
        }
        this.dispose();
