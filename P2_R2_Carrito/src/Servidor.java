    ...
    public static void main(String[] args) throws Exception {
        ...
        for (;;) {
            ...
            while (true) {
                ...
                BufferedInputStream bis = new BufferedInputStream(new FileInputStream("imagec\\" + nombreArchivo));
                int leidos = 0;
                int completados = 0;
            ...
            String ticket = " Se realizó la venta \n";
            float total = 0.0f;
    ...
    public static Disco[] getDiscos() {
        ...
        try {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                disco[i++].setCantidad(Integer.parseInt(datos[5]));
            }
