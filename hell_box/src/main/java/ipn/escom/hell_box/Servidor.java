...
public class Servidor {
	...
	public static void RecibirArchivos(DataInputStream dis, String nombre) throws IOException {
		...
		System.out.println("\\n:::RECEIVING FILE -> " + nombre + " -> " + tam + "BYTES:::");
		...
		while(recibidos < tam) {
			...
			System.out.println("\\r:::" + porciento + "% PROCESSED -> " + recibidos + " OF " + tam + " BYTES:::");
		} // while

		System.out.println(":::RECIEVED FILE ->  " + nombre + ":::");
		dos.close();
		dis.close();
	} // RecibirArchivos
...
*********************************************************************************************/
	public static void zipFile(File fileToZip, String fileName, ZipOutputStream zipOut) throws IOException {
        ...
        fis.close();
        System.out.println(":::READY COMPRESSED FILES:::");
    }
        //delete dir
        public static void deleteDir(File file) 
    {
        ...
        //eliminar
        public static void EliminarArchivos(DataInputStream dis, int size, DataOutputStream dos) 
    {
        try 
        {
            ...
            for (i = 0; i < size; i++) 
            {
                ...
                System.out.println("\n:::FLIE: " + name + ":::");
                File f = new File(rutaServer + name);
                if (flag) 
                {
                    deleteDir(f);
    ...
    public static void EnviarArchivo(DataOutputStream dos, File f) {
		try {
            ...
            while(enviados < tam) {
                ...
                System.out.println("\r::: " + porciento + "% PROCESSED -> " + enviados + " OF " + tam + " BYTES:::");
            } //while

            System.out.println("\n:::RECIEVED FILE -> " + nombre + " :::");
...
*********************************************************************************************/
	...
	public static void main(String[] args) {
		try {
			...
			for( ; ; ) {
				Socket cl = s.accept();
				System.out.println("\n:::HELLO FROM -> " + cl.getInetAddress() + " " + cl.getPort() + ":::");
				DataOutputStream dos = new DataOutputStream(cl.getOutputStream()); //OutputStream
				...
				if(bandera == 0) {
					...
					if(archivoZip.exists()) {
						...
						System.out.println(":::I SAVED YOUT FILES ON A .ZIP FILE IN -> " + path + "::: ::: " + archivoZip.getName());
						...
						if(archivoZip.delete()) 
							System.out.println("TMP" + numVeces + ".zip");
					}
