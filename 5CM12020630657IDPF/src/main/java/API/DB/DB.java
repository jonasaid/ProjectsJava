...
public class DB {
    ...
    public void desconecta(Connection con) throws SQLException {
        con.close();
    }

    public ResultSet ejecuta(Connection con, String sentencia) throws SQLException {
        ResultSet rs = null;
        try {
    ...
    public int ejecuta(String sentencia, String tipo) throws SQLException {
        ...
        }else if("actualiza".contains(tipo)) {
            PreparedStatement query;
